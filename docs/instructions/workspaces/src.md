...
- `src/assets/`: all local image and GIF assets; `public/webIcon.png` and the native cursor files in `public/cursors/` stay in `public/` because CSS references them by root URL
