...
- `src/assets/`: all local image and GIF assets; `public/webIcon.png` and the cursor assets in `public/cursors/` stay in `public/` because the cursor UI references them by root URL
