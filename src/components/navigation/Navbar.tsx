...
export default function Navbar() {
  return (
    <header className="sticky top-0 z-50 w-full border-b-2 border-gray-2 bg-paper-1/95 px-1 py-1 shadow-retro-sm backdrop-blur-sm">
      <div className="flex flex-wrap items-center justify-between gap-2 border-2 border-gray-2 bg-gradient-to-r from-blue-1 via-blue-2 to-cream-2 px-2 py-1.5 text-paper-1 sm:gap-3 sm:px-3">
        <Link
          href="/home"
