...
import { getSpotifyPlaybackState, type SpotifyPlaybackState } from "@lib/spotify";
...
function VinylPlayerContent({ playback }: { playback: SpotifyPlaybackState }) {
  if (!playback.track) {
    return (
...
export default async function VinylPlayer() {
  ...
  return <VinylPlayerContent playback={playback} />;
}
